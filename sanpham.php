...
<?php
  ...
  $sql1 = "SELECT * FROM sanpham WHERE maPhanLoai = 'occho' limit 4 ";
  $result1 = $db ->query($sql1);

  $sql2 = "SELECT * FROM sanpham WHERE maPhanLoai = 'macca' limit 4";
        ...
        <section class="sanPham">
          <?php
            ...
            while($rs1=$result1->fetch()){
              $count++;
          ?>
            <article class="sanPham-items">
                <figure>
                  <img src="img/<?php echo $rs1['anhSP'];?>" alt="">
                </figure>
                <div class="sanPham-info">
                <div class="sanPham-text">
                    <a class="tensanpham" href=""><?php echo $rs1['tenSP'];?></a>
                    <p class="gia"><?php echo number_format($rs1['giaSP']);?>đ</p>
                </div>
                <div class="action">
                    <a href="add-sp.php?maSP=<?php echo $rs1['sanpham_ID'];?>"><button class="order">Mua ngay</button></a>
                    <a href="sanphamchitiet.php?id=<?php echo $rs1['sanpham_ID'];?>"><button class="view">Chi tiết</button></a>
                </div>
                </div>
            </article>
          <?php } ?>
          ...
          ?>
            <article class="sanPham-items">
                <figure>
                  <img src="img/<?php echo $rs2['anhSP'];?>" alt="">
                </figure>
                <div class="sanPham-text">
                    <a class="tensanpham" href=""><?php echo $rs2['tenSP'];?></a>
                    <p class="gia"><?php echo number_format($rs2['giaSP']);?>đ</p>
                </div>
                <div class="action">
                    <a href="add-sp.php?maSP=<?php echo $rs2['sanpham_ID'];?>"><button class="order">Mua ngay</button></a>
                    <a href="sanphamchitiet.php?id=<?php echo $rs2['sanpham_ID'];?>"><button class="view">Chi tiết</button></a>
                </div>
            </article>
          <?php } ?>
        </section>
